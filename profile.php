  ...
  <div class="container" style="margin-top: 5rem; margin-bottom: 5rem;">
    <div class="row">
      <div class="col-md-6 profil text-center">
        <img src="image/profile.png" alt="" width="300px">
      </div>

      <div class="col-md-6 mx-auto text text-center my-auto">
        <h4><?php echo $_SESSION['email']; ?>
        </h4>
        <p><?php echo $nama;  ?>
        <p>Web Programming 1</p>
        <p>UAS</p>
        <form action="edit_profile.php" method="POST" style="margin-bottom: 15px;">
          <button type="submit" class="btn btn-primary">Edit Profile</button>
        </form>
        <a href="config/logout.php" class="btn btn-dark">Logout</a>
      </div>
    </div>
  </div>
